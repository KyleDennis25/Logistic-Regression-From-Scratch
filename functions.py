...
'MODEL FITTING'
'NOTE- Due to the instability of the "amount" variable, "V2" was chosen instead'


# # Load in dataset
# full_data = pd.read_csv("FullCreditCardData.csv")
...
# Use Newton's Method to find logistic regression parameters which maximize the log-likelihood function.
# params_vector = Newtons_Method(subset_data_values, design_matrix_, initial_params) 

# print(params_vector)
# The algorithm converged. The paremeters are: -6.96475858, -0.10128139, and 0.50197949. These maximize the log-likelihood 
# function


# probability_vectorrrr = probability_iteration(design_matrix_, initial_params)
# print(probability_vectorrrr)
